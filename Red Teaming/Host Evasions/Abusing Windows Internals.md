...
The term Windows internals can encapsulate any component found on the back-end of the Windows operating system. This can include processes,  file formats, **COM (Component Object Model)**, task scheduling, I/O System, etc. This room will focus on abusing and exploiting processes and their components, DLLs (**D**ynamic **L**ink **L**ibraries), and the PE (**P**ortable **E**xecutable) format.
...
![img](./assets/ba04c5ef220c10b3e174bd1ca77959c6.png)
...
![img](./assets/3c36b4470fb04e3bfdbbef0674b79ec2.png)
