...
`sudo nmap -sS -n --script "http-date" MACHINE_IP` as shown in the console below.
...
![image-20220817074452865](4. Nmap Post Port Scans.assets/image-20220817074452865.png)
